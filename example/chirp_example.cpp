...
public:
    static void AsyncHandler(const std::string& message) {
    ...
    static void SyncHandler(const std::string& message, int value) {
...
int main() {
    ...
    service.registerMsgHandler("AsyncMessage", SimpleHandlers::AsyncHandler);
    service.registerMsgHandler("SyncMessage", SimpleHandlers::SyncHandler);
    ...
    // Wait a bit to let any remaining async messages finish
